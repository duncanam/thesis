...
\centering 
\includegraphics[width=\textwidth]{figs/detcells.png}
...
\begin{figure}[]
    ...
    \centering
    \includegraphics[width=0.85\textwidth]{figs/cfl_test/p.png}
    ...
    \begin{subfigure}[]{\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{figs/cfl_test/t.png}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/static1d/p.png}
        \caption{Pressure plot}
    \end{subfigure}

    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/static1d/t.png}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/staticfigs/p.png}
        \caption{Pressure plot}
        \label{fig:2dstaticp}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/staticfigs/t.png}
        \caption{Temperature plot}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{0.95\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/staticfigs/u.png}
        \caption{Fluid velocity plot}
        \label{fig:2dstaticu}
    \end{subfigure}
    ...
    \begin{subfigure}[]{0.95\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/staticfigs/y.png}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/example_results/p.png}
        \caption{Pressure plot}
    \end{subfigure}

    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/example_results/t.png}
        \caption{Temperature plot}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/example_results/u.png}
        \caption{Fluid velocity magnitude plot}
    \end{subfigure}

    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/example_results/rho.png}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinelevels/p.png}
        \caption{Pressure plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinelevels/pe.png}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinelevels/t.png}
        \caption{Temperature plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinelevels/te.png}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinelevels/u.png}
        \caption{Fluid velocity plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinelevels/ue.png}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_bufflayers/p.png}
        \caption{Pressure plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_bufflayers/pe.png}
        \caption{Pressure plot, enlarged}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_bufflayers/t.png}
        \caption{Temperature plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_bufflayers/te.png}
        \caption{Temperature plot, enlarged}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_bufflayers/u.png}
        \caption{Fluid velocity plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_bufflayers/ue.png}
        \caption{Fluid velocity plot, enlarged}
    \end{subfigure}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinebounds/p.png}
        \caption{Pressure plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinebounds/pe.png}
        \caption{Pressure plot, enlarged}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinebounds/t.png}
        \caption{Temperature plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinebounds/te.png}
        \caption{Temperature plot, enlarged}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinebounds/u.png}
        \caption{Fluid velocity plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amr_refinebounds/ue.png}
        \caption{Fluid velocity plot, enlarged}
    \end{subfigure}
...
\subsection{AMR and Static Comparison}
...
\begin{figure}[]
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amrcompare/p.png}
        \caption{Pressure plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amrcompare/pe.png}
        \caption{Pressure plot, enlarged}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amrcompare/t.png}
        \caption{Temperature plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amrcompare/te.png}
        \caption{Temperature plot, enlarged}
    \end{subfigure}
...
\begin{figure} \ContinuedFloat
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amrcompare/u.png}
        \caption{Fluid velocity plot}
    \end{subfigure}
    ...
    \begin{subfigure}[]{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth]{./figs/amrfigs/amrcompare/ue.png}
        \caption{Fluid velocity plot, enlarged}
    \end{subfigure}
